...
def register_tool(mcp, client: InfluxDBClient):
    @mcp.tool()
    def get_time_window_summary(database_name: str, measurement_name: str, field_key: str, time_window: str, filters: str = None, group_by_tags: str = None) -> str:
        """
        ...
        # InfluxDB는 결과가 없어도 오류를 반환하지 않으므로, 응답을 그대로 반환합니다.
        return response
